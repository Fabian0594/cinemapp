          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600 dark:text-gray-400">Catálogo de Películas</p>
              </div>
            </div>
      ...
      <section className="container mx-auto px-4 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 mb-8">
            Descubre las mejores películas en nuestra colección
          </p>
          ...
          <div className="max-w-2xl mx-auto mb-8">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-4 bg-white dark:bg-slate-800 border border-gray-300 dark:border-slate-600 rounded-xl text-gray-900 dark:text-white placeholder-gray-400 focus:ring-2 focus:ring-purple-500 focus:border-transparent shadow-lg transition-all outline-none"
              />
            </div>
          </div>
          ...
          {/* Filtros */}
          <div className="flex items-center gap-3 px-4 py-3 flex-wrap justify-center">
        ...
        <section className="py-8">
          <h2 className="text-gray-900 dark:text-white text-[22px] font-bold tracking-[-0.015em] px-4 pb-4 text-center">
          ...
          {loading ? (
            ...
            <div className="text-center py-20">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                {searchTerm ? 'Intenta con otros términos de búsqueda' : 'El catálogo está vacío'}
              </p>
            </div>
          ) : (
            <>
